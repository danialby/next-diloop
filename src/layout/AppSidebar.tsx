...
import { CalendarXIcon, ChevronDown, Grid2X2Icon, ListXIcon, UserCircleIcon } from 'lucide-react'
...
const AppSidebar: React.FC = () => {
  ...
  const { setCoursePageTitle } = useGlobalStore()
  ...
  useEffect(() => {
    ...
    diloopNavItems.forEach((nav, index) => {
      if (nav.subItems) {
