...
export default function InputCodeForm() {
  ...
  const handleVerify = (data: object) => {
    console.warn(data)
        ...
        <div className="flex flex-col flex-1 w-full items-center justify-center">
          ...
          <div className="text-center flex flex-col gap-2 mb-4 items-center">
            <p className="text-sm text-gray-500 dark:text-gray-400">
              کد تایید به شماره
              <span
                className="font-bold text-lg px-2 text-black dark:!text-blue-500 tracking-[1px]"
              >
                {userLoginNumber}
              </span>
              ارسال شد.
          ...
          <div>
            <div className="flex flex-1 flex-col  m-0 w-full">
              <div className="flex justify-between flex-row-reverse text-xs">
                <Link className="flex items-center gap-1 dark:text-gray-400" href="/auth/login">
