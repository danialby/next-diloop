            ...
            <div className="flex flex-col col-span-2 gap-y-3">
              <span className="flex items-center">
                <div className="flex gap-2 items-center">
                  <span className="flex text-sm text-nowrap font-semibold">
                    {' '}
              ...
              <span className="flex items-center">
                <div className="flex gap-2 items-center">
                  <span className="flex text-sm text-nowrap font-semibold">
                    {' '}
                    <SpellCheck className="w-6 h-6 ml-2" />
                    نام انگلیسی :
                  </span>
              ...
              <span className="flex items-center">
                ...
                <div className="flex gap-2 items-center">
                  <span className="flex  text-sm text-nowrap font-semibold">
                    {' '}
                    <CalendarCheck2 className="w-6 h-6 ml-2" />
                    {' '}
                    تاریخ و ساعت :
                  </span>
                  <span className="text-xs text-nowrap">
                    {toPersianDate(category?.created_at)}
                    {' '}
                    -
                    {toPersianTime(category?.created_at)}
                  </span>
                </div>
              </span>
              <span className="flex items-center">
                <div className="flex gap-2 items-center">
                  <span className="flex text-sm text-nowrap font-semibold">
                    {' '}
                    <AlignRight className="w-6 h-6 ml-2" />
                    توضیحات :
                  </span>
