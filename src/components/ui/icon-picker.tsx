...
function IconPicker({ ref, value, defaultValue, onValueChange, open, defaultOpen, onOpenChange, children, searchable = true, searchPlaceholder = 'Search for an icon...', triggerPlaceholder = 'Select an icon', iconsList, categorized = true, ...props }: IconPickerProps & { ref?: React.RefObject<React.ComponentRef<typeof PopoverTrigger> | null> }) {
...
function Icon({ ref, name, ...props }: IconProps & { ref?: React.RefObject<React.ComponentRef<LucideIcon> | null> }) {
