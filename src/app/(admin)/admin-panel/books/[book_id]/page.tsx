...
export default function BookEditor() {
  ...
  const renderPageList = () => (
    <div className="max-h-50 md:grid grid-cols-5 gap-1.5 overflow-y-auto p-3 bg-black/5 rounded-xl shadow">
                  ...
                  <div className="h-full flex flex-col pt-3">
                    ...
                    <div className="flex-1 overflow-auto">
                      <BookCreator
                        ...
                        onNext={() => setCurrentPageIndex(prev =>
                          prev < pages.length - 1 ? prev + 1 : 0,
                        )}
                        onPrev={() => setCurrentPageIndex(prev =>
                          prev > 0 ? prev - 1 : pages.length - 1,
                        )}
                        onClose={() => handleDeletePage(currentPageIndex)}
                        onIndexChange={setCurrentPageIndex} // Pass the setCurrentPageIndex function here**
                      />
                    </div>
                    ...
                    <div className="p-4 border-t flex justify-between bg-gray-50">
                      <Button
                        variant="outline"
                        onClick={() => setCurrentPageIndex(prev =>
                          prev > 0 ? prev - 1 : pages.length - 1,
                        )}
                      >
                        قبلی
